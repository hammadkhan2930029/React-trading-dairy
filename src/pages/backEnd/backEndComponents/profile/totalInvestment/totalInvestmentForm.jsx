...
import { selectAllTransaction, createTransactions, fetchTransactions, updateTransactions } from "../../../Redux/transactionSlice";
...
export const TotalInvestment = () => {
    ...
    const investmentList = TotalInvestmentList.filter(item => item.fore === 'Investment');
    ...
    // FIXED: Updated handleUpdateTransaction with proper form submission
    const handleUpdateTransaction = async (e) => {
        ...
        try {
            ...
            setSnackbarMessage(`Transaction update failed '${error.message}'`);
            setSnackbarSeverity("error");
            setSnackbarOpen(true);
        }
    };
                        ...
                        <div className='investmentform'>
                            ...
                            <button className='backBtn' onClick={() => {
                                ...
                                <div className='investment_form_oneTime'>
                                    <div className='total_investment_input_div'>
                                        <TextField
                                            type='date'
                                            id="outlined-required"
                                            label="Date"
                                            name="date"
                                            className='investment_field'
                                            value={values.date}
                ...
                <div className="investment_crud_main_onetime">
                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align='center'>Total Investment</StyledTableCell>
                    ...
                    {/* <table className="investment_table_onetime">
                        ...
                        <tbody className='investment_t_body_onetime'>
                            {investmentList.slice(page * rowsPerPage, (page + 1) * rowsPerPage).map((item, index) => (
