                            ...
                            <div className='form-main-buy'>
                                ...
                                <div className='btn_div_buy'>
                                    ...
                                    <div className='switchBtn_div_buy'>
                                        ...
                                        <button className='switchBtn_buy' onClick={() => navigate('/sell')}>Sell</button>
                                    </div>
                                </div>
                                    ...
                                    >
                                        <div className='form_buy'>
                                            ...
                                            <Autocomplete
                                                ...
                                                autoHighlight
                                                autoSelect
                                                value={stocks.find(s => s.id === formik.values.stock_id) || null}
                                                onChange={(event, newValue) => {
                                                    setFieldValue("stock_id", newValue ? newValue.id : "");
                                                }}
                                                renderInput={(params) => (
                                                    <TextField
                                                        {...params}
                                                        ...
                                                        helperText={touched.stock_id && errors.stock_id}
                                                        fullWidth
                                                    />
                                                )}
