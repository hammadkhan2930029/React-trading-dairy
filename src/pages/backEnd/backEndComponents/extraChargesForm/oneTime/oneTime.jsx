...
export const OneTime = () => {
    ...
    return (
        ...
        >
            ...
            {/* ============================================================================================== */}
            {/* Table Display */}
            <motion.div className="ex_charges_list_onetime"
                ref={refOne}
                initial={{ opacity: 0, y: -100 }}
                animate={inViewOne ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: .8 }}>
                        ...
                        <Table sx={{ minWidth: 650, tableLayout: "auto" }} aria-label="customized table">
                            <TableHead >
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center">Registration Charges</StyledTableCell>
                                    <StyledTableCell align="center">NCCPL Charges</StyledTableCell>
                                ...
                                {oneTimeChargesFiltered.length > 0 ? (
                                    oneTimeChargesFiltered.map((item) => (
                                        <TableRow key={item.id} >
                                            <StyledTableCell align="center">{item.transaction_date ? formatDate(item.transaction_date) : 'N/A'}</StyledTableCell>
                                            <StyledTableCell align="center">{item.registrationCharges}</StyledTableCell>
                                            <StyledTableCell align="center">{item.nccplCharges}</StyledTableCell>
