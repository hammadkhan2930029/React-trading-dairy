...
export const SummaryDetailsPage = () => {
    ...
    let selectedSummary = useSelector(state => state.summary.selectedSummary) || [];
                            ...
                            <TableBody>
                                ...
                                {filteredData.map((item, index) => (
                                    <StyledTableRow key={index}>
                                        <StyledTableCell component="th" scope="row">{formatDate(item.date)}</StyledTableCell>
                                        <StyledTableCell>{item.scrip}</StyledTableCell>
                                        <StyledTableCell>{intlNumFormatTwoDecimal.format(item.ldcp)}</StyledTableCell>
                                        <StyledTableCell>{intlNumFormatTwoDecimal.format(item.high)}</StyledTableCell>
                                        <StyledTableCell>{intlNumFormatTwoDecimal.format(item.low)}</StyledTableCell>
                                        <StyledTableCell>{intlNumFormatTwoDecimal.format(item.current)}</StyledTableCell>
                                        <StyledTableCell>{intlNumFormatTwoDecimal.format(item.change)}</StyledTableCell>
                                        <StyledTableCell>{intlNumFormatNoDecimal.format(item.volume)}</StyledTableCell>
