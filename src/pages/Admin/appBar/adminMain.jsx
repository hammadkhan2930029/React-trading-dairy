...
import { UserImports } from '../userImports/userImports.jsx';
...
import { Summary } from '../../Admin/marketData/marketSummary/summary.jsx'
import { SummaryIndex } from '../../Admin/marketData/marketSummaryIndex/summaryIndex.jsx';
import { OverView } from '../../Admin/marketData/marketOverview/overview.jsx';
import { OverviewIndex } from '../../Admin/marketData/marketOverviewList/overviewIndex.jsx';
import { resetSummary } from '../../backEnd/Redux/summarySlice.js';
//import ProfilePage from '../../home/profile/profile.jsx';
...
export const AdminMain = (props) => {
    ...
    const menuItems_one = [
        ...
        { value: 992, name: ' Users' },
        { value: 995, name: ' Stocks' },
        { value: 996, name: ' User Imports' },
    ];
    // -------------------------------------------------
    const menuItems_two = [
        { value: 5, name: 'Header' },
                    ...
                    <ListItem key={item.value} disablePadding>
                        ...
                        >
                            <ListItemIcon sx={{ color: selectedIndex === item.value ? '#fff' : '#000', }}>
                                {item.value === 991 || item.value === 992 ? <FormatListBulletedIcon /> : item.value === 995 ? <FormatListBulletedIcon /> : item.value === 996 ? <FileUploadOutlinedIcon /> : <MailIcon />}
    ...
    const renderForm = () => {
        ...
        if (count !== null && count !== undefined) {
            switch (count) {
                ...
                case 995: return <StockName />;
                case 996: return <UserImports />;
                default: return null;
            }
        }
